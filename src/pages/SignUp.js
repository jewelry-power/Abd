...
function SignUp() {
  ...
  function handelSubmit(e) {
    ...
    if (emailValidate(email) && UserValidate(name) && PassWordValidate(password)) {
        ...
        <div className="w-full h-100">
          ...
          <form className="mt-6" action="#" method="POST">
            ...
            <div className="mt-4">
              ...
              <p className={ppassword}>your pass word should be at least 8 characters,special characters,small and big letters </p>
            ...
            <button type="submit" className="w-full  bg-amber-300  hover:bg-amber-300 focus:bg-amber-300 text-black font-semibold rounded-lg
                px-4 py-3 mt-6" onClick={handelSubmit}> sign up </button>
