...
// import imge from 'golden-whisper/jewelry/src/images/about-us.png'
// import video from "src/images/Jamie_Chastain_1.mp4"
function AboutUs() {
  ...
  return (
    ...
    <div>
      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
        <div className="flex flex-col lg:flex-row justify-between gap-8">
          ...
          <div className="w-full lg:w-8/12 ">
            <img className="w-full h-full" src='' alt="A group of People" />
          </div>
        </div>
      ...
      <div className='w-full h-50 grid grid-cols-1 grid-rows-2'>
        ...
        {/* <div className='flex items-center justify-center order-2 lg:order-2 relative before:block before:absolute before:w-20 before:h-100  xl:before:bg-black  before:-inset-1  before:left-0 before:left-48   before:-rotate-180	 before:bg-amber-300  '>
          <iframe className='z-10  w-8/12 aspect-video ' src="golden-whisper/jewelry/src/images/Jamie_Chastain_1.mp4"></iframe>      
            </div> */}
      </div>
    </div>
  )
